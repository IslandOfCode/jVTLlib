...
public class ValueDomain implements VTLObj {
	 ...
	 * regolare non � sintatticamente valida.
	 * @param name
	 * @param rg
	 * @param type
	 ...
	 * Questa classe si � deciso di non implementarla (è ridondante), ma questo approccio � rimasto.
	 * Dato che viene sempre passato uno {@link Scalar} come {@link #datatype}, questo metodo 
	 * � consigliato rispetto al precedente, {@link #getDataType()}. 
	 ...
	 * <br>
	 * Attenzione! Se lo {@link Scalar} associato alla chiave � nullo, allora viene ritornato <i>true</i>,
	 * senza controlli aggiuntivi, perch� si assume che <b>null</b> faccia sempre parte del dominio.
	 * @param in {@link DataPoint}
	 * @return boolean
	 */
	public boolean checkDomain(DataPoint in, String key) {
		//per "contratto", key � sempre non vuota.
		Scalar tmp = in.getValue(key);
		
		//se lo scalare esiste ed � non nullo...
		if(tmp!=null) {
		...
		//quella chiave non esiste nel data point, oppure non � conforme al dominio
		return false;
	}
